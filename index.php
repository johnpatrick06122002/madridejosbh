    ...
    <div class="col-lg-4 col-md-6 col-sm-12">
      <div class="course_card">
        ...
        <div class="course_card_content">
          ...
          <div class="row">
            <div class="col-sm-8">₱ <?php echo $row['monthly']; ?> / Monthly<br/></div>
            <div class="col-md-4">
              <?php
          ...
          <i class="fa fa-map-marker" aria-hidden="true"></i> <?php echo $row['address']; ?><br/>
        </div>
  ...
  <center>
    <ul class="pagination">
      <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?>">
        <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1)."#recent"; } ?>">
          <i class="fa fa-chevron-left" aria-hidden="true"></i> Prev
        </a>
      </li>
      <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?>">
        <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1)."#recent"; } ?>">

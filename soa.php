...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['book_ref_no'])) {
    ...
    if ($booking && $booking['payment_id']) {
        ...
        // Calculate balance
        if (isset($booking['monthly'])) {
            $balance = $booking['monthly'] - $totalPayments;
        }
    }
}
?>
            ...
            <?php else: ?>
                ...
                <?php elseif ($booking['status'] === 'Confirm'): ?>
                    ...
                    <div class="details-card">
                        ...
                        <p class="mb-2"><strong>Monthly Rent:</strong> ₱<?php echo number_format(htmlspecialchars($booking['monthly']), 2); ?></p>
                        <p class="mb-2"><strong>Total Payments:</strong> ₱<?php echo number_format($totalPayments, 2); ?></p>
                        <p class="mb-2"><strong>Balance:</strong> ₱<?php echo number_format(max($balance, 0), 2); ?></p>
                    </div>
